...
\renewcommand{\max}[1]{{\color{purple}mw: #1}}
\newcommand{\mw}[1]{{\color{purple}mw: #1}}
\newcommand{\thia}[1]{{\color{blue}th: #1}}
\newcommand{\zach}[1]{{\color{green}ztatlock: #1}}
\newcommand{\amy}[1]{{\color{brown}az: #1}}
\newcommand{\oliver}[1]{{\color{brown}ol: #1}}
\newcommand{\brett}[1]{{\color{teal}br: #1}}
\newcommand{\chandra}[1]{{\color{cyan}cn: #1}}
\newcommand{\ryan}[1]{{\color{teal}ry: #1}}
\newcommand{\anjali}[1]{{\color{teal}aj: #1}}
\newcommand{\sandy}[1]{{\hl{#1}}}
...
\newcommand{\ints}{ℤ}
\newcommand{\reals}{ℝ}
\newcommand{\Append}{\textsf{Union}\xspace}
\newcommand{\Union}{\textsf{Union}\xspace}
\newcommand{\Filter}{\textsf{Filter}\xspace}
\newcommand{\Plug}{\textsf{Plug}\xspace}
\newcommand{\append}{\textsf{append}\xspace}
\newcommand{\filter}{\textsf{filter}\xspace}
\newcommand{\metric}{\textsf{metric}\xspace}
\newcommand{\prune}{\textsf{prune\_wl}\xspace}
\newcommand{\force}{\textsf{force}\xspace}
\newcommand{\plug}{\textsf{plug\_wl}\xspace}
\newcommand{\plugs}{\textsf{plug\_sexp}\xspace}
% \newcommand{\eggl}{$\operatorname{e-graph_L}$\xspace}
\newcommand{\eggl}{$\mathsf{egraph}$\xspace}
% \newcommand{\ruleset}{$\operatorname{ruleset_L}$\xspace}
\newcommand{\ruleset}{$\mathsf{ruleset}$\xspace}
% \newcommand{\rl}{$\operatorname{rule_L}$\xspace}
\newcommand{\rl}{$\mathsf{rule}$\xspace}
% \newcommand{\patl}{$\operatorname{pattern_L}$\xspace}
\newcommand{\patl}{$\mathsf{pattern}$\xspace}
% \newcommand{\toeggl}{$\operatorname{to\_egraph_L}$\xspace}
\newcommand{\toeggl}{$\mathsf{to\_egraph}$\xspace}

\newcommand{\ruler}{Ruler\xspace}
\newcommand{\rust}{Rust\xspace}
\newcommand{\tessy}{TheSy\xspace}
\newcommand{\herbie}{Herbie\xspace}
\newcommand{\sz}{Szalinski\xspace}
\newcommand{\megalibm}{Megalibm\xspace}
\newcommand{\halide}{Halide\xspace}
