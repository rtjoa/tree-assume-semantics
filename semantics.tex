...
\bigstep{\strip{e}{\targ}{\tmem}}{\spair{v}{\tmem'}} means that with argument $\targ$ and state $\tmem$, $e$ evaluates to $v$ and the resulting state is $\tmem'$.
...
\inferrule{E-IfTrue}{
  \bigstep{\strip{c}{\targ}{\sigma}}{\spair{true}{\sigma'}} \andalso
...
\inferrule{E-IfFalse}{
  \bigstep{\strip{c}{\targ}{\sigma}}{\spair{false}{\sigma'}} \andalso
...
\inferrule{E-Let}{
  ...
  \bigstep{\strip{o}{\targ'}{\sigma'}}{\spair{o}{\sigma''}}
}
{\bigstep{
